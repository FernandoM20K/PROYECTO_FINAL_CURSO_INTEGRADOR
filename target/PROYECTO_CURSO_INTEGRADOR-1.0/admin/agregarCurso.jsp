...
<div class="contenedord">
    ...
    <div class="informacion notas">
        ...
        <div class="tabla">
            <form action="${pageContext.request.contextPath}/ControladorCurso?accion=insertar" method="post">
                <div>
                    <label for="nombreCurso">Nombre del Curso</label>
                    <input type="text" id="nombreCurso" name="nombreCurso" class="block-100" required>
                </div>
                
                <div>
                    <label for="horasSemana">Horas a la Semana</label>
                    <input type="number" id="horasSemana" name="horasSemana" class="block-100" required>
                </div>

                <div>
                    <label for="duracionSemanas">Duracion en Semanas</label>
                    <input type="number" id="duracionSemanas" name="duracionSemanas" class="block-100" required>
                </div>

                <div>
                    <label for="idProfesor">Profesor</label>
                    <select id="idProfesor" name="idProfesor" class="block-100" required>
